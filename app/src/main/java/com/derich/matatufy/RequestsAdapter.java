...
public class RequestsAdapter extends RecyclerView.Adapter<RequestsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final Boolean approval = activeRideshares.getStatus();
        ...
        holder.btnApprove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ActiveRideshares activeRideshares = new ActiveRideshares(ridesharerEmail, email, date,time, phoneNum,true);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ActiveRideshares activeRideshares = new ActiveRideshares(ridesharerEmail, email, date,time, phoneNum,false);
